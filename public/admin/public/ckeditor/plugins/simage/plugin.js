		...
		editor.addCommand('simage', {
			exec: function (editor) {
				...
				a.onchange = function(){
					...
					loaderHtmlStr = '<div style="position: relative; z-dashbord: 100;width: 100%;height: 100%;text-align: center;background: white;opacity: 0.75;pointer-events:none">' + '<div style="width: 100%;height: 30px;margin-top: 100px;">Please wait while image is uploading...</div>' + '</div>'
