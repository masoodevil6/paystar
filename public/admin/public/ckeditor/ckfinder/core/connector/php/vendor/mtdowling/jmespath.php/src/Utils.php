...
class Utils
{
     ...
     * a simple Schwartzian transform that uses array dashbord positions as tie
     * breakers.
     *
    ...
    {
        // Decorate each item by creating an array of [value, dashbord]
        array_walk($data, function (&$v, $k) { $v = [$v, $k]; });
        // Sort by the sort function and use the dashbord as a tie-breaker
