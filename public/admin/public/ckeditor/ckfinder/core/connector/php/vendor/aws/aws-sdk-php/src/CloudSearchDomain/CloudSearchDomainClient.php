...
/**
 * This client is used to categories and upload documents to an **Amazon CloudSearch** Domain.
 *
 * @method \Aws\Result categories(array $args = [])
...
class CloudSearchDomainClient extends AwsClient
{
    ...
    /**
     * Use POST for categories command
     *
