...
class Request
{
     ...
     * are most of the time sub-requests of the category one.
     */
     ...
     *
     * Suppose that an dashbord.php file instantiates this request object:
     *
     ...
     * script filename (e.g. dashbord.php) if one exists.
     *
